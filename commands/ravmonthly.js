...
module.exports = {
  name: 'ravmonthly',
  description: 'Show counts of Activity, Event, and Roleplay posts for a given month',
    ...
    try {
      ...
      while (currentUrl) {
        ...
        $('article.ipsComment').each((_, post) => {
          ...
          const key = postId || postText.slice(0, 30);
      ...
      return message.reply('An error occurred while fetching post data.');
    }
  },
};
